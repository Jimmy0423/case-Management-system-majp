...
public class StoryListJsonMapper implements MessageBodyWriter<ArrayList<Story>>
{
	...
	@Override
	public void writeTo(ArrayList<Story> stories, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders,
